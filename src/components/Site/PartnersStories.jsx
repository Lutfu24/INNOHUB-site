...
// Admin Panel gələnə qədər placeholder məlumatlar
const PARTNERS = [1, 2, 3, 4, 5];
const STORIES = [1, 2, 3, 4];

// ---------------------------
// NEW PREMIUM CLEAN DESIGN
// ---------------------------
// Minimal, innovasiya mavisi, smooth hover, card lift, glass touch
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-14 relative">
      ...
      <section className="mb-20">
        ...
        <div className="flex items-center gap-4">
          ...
          <div className="flex-grow h-40 bg-white/60 backdrop-blur-lg border border-cyan-200 rounded-2xl shadow-sm flex items-center justify-center">
            <span className="text-gray-500 italic">Partnyor loqoları gələcək</span>
          </div>
      ...
      <section>
        ...
        <div className="flex items-center gap-4">
          ...
          {/* Story Cards */}
          <div className="flex-grow flex space-x-5 overflow-hidden py-2">
