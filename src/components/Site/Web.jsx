              ...
              {syllabus.map((item, idx) => (
                <div key={idx} className="border-b last:border-none min-w-0">
                  <button
                    ...
                    className="w-full flex cursor-pointer justify-between items-center py-3 text-left"
                  >
          ...
          <div className="lg:col-span-2 space-y-10 min-w-0">
            ...
            <div className="text-center">
              <button
                ...
                className="bg-[#02C8FE] cursor-pointer text-white px-6 py-3 rounded-xl text-sm"
              >
                Kursa Qoşul
              </button>
            </div>
              ...
              {!submitted ? (
                <form onSubmit={handleSubmit} className="space-y-3">
                  ...
                  <input
                    ...
                    placeholder="Telefon"
                  />
                  <button className="w-full cursor-pointer bg-[#02C8FE] text-white py-2 rounded-lg">
                    Göndər
                  </button>
                  <button
                    onClick={() => setShowModal(false)}
                    className="w-full cursor-pointer bg-[#e4eee7] text-back py-2 rounded-lg"
                  >
                    Çıx
                  </button>
                </form>
