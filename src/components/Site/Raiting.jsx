function Raiting() {
  return (
    <section className="@container my-5 dark:bg-gray-100 dark:text-gray-800">
      <h1 className="font-bold text-3xl ml-7 my-4">Niyə biz?</h1>
      <div className="mx-auto grid justify-center grid-cols-2 text-center lg:grid-cols-5">
        <div className="flex flex-col justify-start m-2 lg:m-6 bg-sky-300/20 rounded-3xl py-4 hover:scale-105 hover:shadow-2xl hover:duration-300 cursor-zoom-in hover:ease-in-out">
