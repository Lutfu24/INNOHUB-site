...
const TEACHING_FIELDS = [
  ...
  },
  {
    ...
    description: "Marketinq strategiyaları və rəqəmsal alətlər üzrə bilik əldə edin.",
  },
  {
    id: 4,
    name: "Fotografiya",
    imageUrl: "/images/photography.png",
    description: "Fotoqrafiya və vizual kommunikasiya sahəsində təcrübə qazanın.",
  },
];
  ...
  <div className="w-full sm:w-1/3 md:w-1/4 cursor-pointer transition-transform duration-300 hover:scale-105">
    <div className="relative overflow-hidden rounded-2xl shadow-lg bg-white aspect-[4/5] flex flex-col items-center justify-center p-6 hover:shadow-xl">
      <div className="absolute -top-6 w-28 h-28 rounded-full bg-gray-100 flex items-center justify-center">
        <img src={field.imageUrl} alt={field.name} className="w-20 h-20 object-contain" />
      </div>

      <h3 className="mt-24 text-lg font-bold text-gray-900 text-center">{field.name}</h3>
      <p className="mt-2 text-sm text-gray-500 text-center">{field.description}</p>
    </div>
  </div>
);
...
const TeachingFieldsPage = () => {
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h2 className="text-3xl font-bold text-gray-900 mb-10 text-center">Tədris Sahələri</h2>
