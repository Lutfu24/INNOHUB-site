...
// Nümunə müəllim məlumatları
const DUMMY_TEACHERS = [
  { id: 1, name: "Asif Məmmədov", subject: "Riyaziyyat", imageUrl: "/images/asif_mammadov.png" },
  { id: 2, name: "Samirə Əliyeva", subject: "İngilis dili", imageUrl: "/images/samira_aliyeva.png" },
  { id: 3, name: "Leyla Səməd", subject: "Graphic Designer", imageUrl: "/images/leyla_samad.png" },
];
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="flex justify-center mt-12">
        <a href="/all-teachers" className="flex items-center text-lg font-medium text-gray-700 hover:text-cyan-700 transition-colors group">
          Bütün müəllimlər
          <span className="ml-2 text-xl font-bold text-cyan-700 group-hover:ml-3 transition-all duration-300">&gt;</span>
        </a>
      </div>
    </div>
  );
